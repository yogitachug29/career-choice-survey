...
HEADERS = [
    "Name", "Phone Number", "Age", "Study Year", "Career", "Specialization",
    "Career Clarity", "Reasons", "Who Helped", "Salary Importance",
    "Job Opportunity Importance", "Job Security Importance", "Career Growth Importance",
    "Interest Importance", "Work Life Balance Importance", "Respect Importance",
    "Weekly Learning Hours", "Certificate", "Internship", "Project", "After College",
    "Preferred Work Location", "Expected Starting Salary", "Currently Working", "Current Job",
    "Current Industry", "Years of Experience", "Current Salary",
    "Did Current Career Match Childhood/Student Choice", "Employee Career Change"
]
...
def submit():
    ...
    row = [
        ...
        reasons, who_helped, salary_importance, job_opportunity_importance,
        job_security_importance, career_growth_importance, interest_importance,
